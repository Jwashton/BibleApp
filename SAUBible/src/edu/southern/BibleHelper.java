...
public class BibleHelper {
	...
	public int GetChapterCount(String bookName){	
		...
		return numChapters[bookIndex];
	}
	
	public int GetVersesInChapter(String bookName, int chapterNumber){
		int bookNumber = GetBookNumber(bookName);
		if(bookNumber != -1 && chapterNumber <= numChapters[bookNumber])
			return verses[bookNumber][chapterNumber];
		return 0; // or throw exception?
	}
	
	public int GetVersesInChapter(String bookAndChapter){
		String parts[] = bookAndChapter.split(" ");
		int chapterNumber=0;
		try	{
			chapterNumber = Integer.parseInt(parts[parts.length-1]);
		} catch(NumberFormatException e){
			//throw an exception here or return 0
		}
		if(chapterNumber>0){
			String bookName = "";
			for(int i=0; i < parts.length-1; i++)
				bookName += parts[i];
			return GetVersesInChapter(bookName);
		}else
			return 0; // or exception?
	}
	
	private final String books[] = { "Genesis", "Exodus", "Leviticus", "Numbers",
	...
	private final char numChapters[] = {/*old testament*/ 50, 40, 27, 36, 34, 24, 21, 4, 31, 24, 22, 25,
			29, 36, 10, 13, 10, 42, 150, 31, 12, 8, 66, 52, 5, 48, 12, 14, 3,
			9, 1, 4, 7, 3, 3, 3, 2, 14, 4,/*new testament*/ 28, 16, 24, 21, 28, 16, 16, 13, 6,
			6, 4, 4, 5, 3, 6, 4, 3, 1, 13, 5, 5, 3, 5, 1, 1, 1, 22 };
	private final int verses[][] = {
		/* Genesis */
		{31, 25, 24, 26, 32, 22, 24, 22, 29, 32, 32, 20, 18, 24, 21, 16, 27, 33,
		38, 18, 34, 24, 20, 67, 34, 35, 46, 22, 35, 43, 55, 32, 20, 31, 29,
		...
		31, 25, 26, 47},
		/* Acts */
		{26, 37, 42, 15, 60, 40, 43, 48, 30, 25, 52, 28, 41, 40, 34, 28, 41,
		...
		24, 21, 15, 27, 21 }};
/*
	public short BookStart[] = { 1, 51, 91, 118, 154, 188, 212, 233, 237, 268,
			292, 314, 339, 368, 404, 414, 427, 437, 479, 629, 660, 672, 680,
			746, 798, 803, 851, 863, 877, 880, 889, 890, 894, 901, 904, 907,
			910, 912, 926, 930, 958, 974, 998, 1019, 1047, 1063, 1079, 1092,
			1098, 1104, 1108, 1112, 1117, 1120, 1126, 1130, 1133, 1134, 1147,
			1152, 1157, 1160, 1165, 1166, 1167, 1168 };
	*/
}
